...
class CorpusEs:
    ...
    def get_os_environ_variables(self):
        ...
        self.es_host = 'http://' + os.environ.get('AZ_SD_ES_HOST')
        self.es_user = os.environ.get('AZ_SD_ES_USER')
        self.es_pwd = os.environ.get('AZ_SD_ES_PWD')
    ...
    def set_es_conn(self):
        ...
        self.es_conn = Elasticsearch([self.es_host], http_auth=(self.es_user, self.es_pwd),timeout=30)
